...
Open Banking is a reform, called for by the Competitions & Market Authority (CMA), which mandates the largest current account providers (CMA9) to securely share customer account data and initiate payments with registered third party providers (TPPs) provided the customer has given their consent.
